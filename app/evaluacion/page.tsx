...
import { Spinner, Table, Label, Radio, Button } from "flowbite-react";
...
export default function EncuestaPage() {
  ...
  const idEncuesta = url.searchParams.get("id");
              ...
              <Table.Body className="divide-y">
                {encuesta[0].pregunta1.pregunta ? (
                  <Table.Row key="pregunta1">
                    <Table.Cell>
                      <Label value={encuesta[0].pregunta1.pregunta as string} />
                    </Table.Cell>
                    <Table.Cell>
                ...
                {encuesta[0].pregunta2.pregunta ? (
                  <Table.Row key="pregunta2">
                    <Table.Cell>
                      <Label value={encuesta[0].pregunta2.pregunta as string} />
                    </Table.Cell>
                    <Table.Cell>
                ...
                {encuesta[0].pregunta3.pregunta ? (
                  <Table.Row key="pregunta1">
                    <Table.Cell>
                      <Label value={encuesta[0].pregunta3.pregunta as string} />
                    </Table.Cell>
                    <Table.Cell>
